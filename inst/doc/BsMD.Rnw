...
DanielPlot(advance.lm,cex.pch=0.8,main="b) Labelled Plot",pch=20,
    labels=list(pt=c(2,4,8),lab=c(" 2"," 4"," 8")))
@
\end{center}
...
DanielPlot(strength.lm,half=TRUE,cex.pch=0.8,main="a) Half-Normal Plot",
    labels=list(pt=c(4,12,13),lab=c(" x4"," x12"," x13")))
DanielPlot(strength.lm,main="b) Normal Plot",
    labels=list(pt=c(4,12,13),lab=c(" 4"," 12"," 13")))
@
\end{center}
...
DanielPlot(advance.lm,cex.pch=0.6,main="b) Daniel Plot",
        labels=list(pt=c(2,4,8),lab=c(" x2"," x4"," x8")))
...
DanielPlot(yield.lm,cex.pch=0.6,main="b) Daniel Plot",
    labels=list(pt=c(1,7,8,9,10,14),lab=paste(" ",c(1,7,8,9,10,14),sep="")))
...
perspective in \citet[chap.~7]{BHH2-2004}. The full design matrix and
response is:
...
displayed in the figure below. See \citet[chap.~7]{BHH2-2004} for discussion
